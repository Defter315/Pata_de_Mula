...
<div class="container">
    <center>
        <h3 style="font-weight: bold;">Lista de clientes</h3>
    </center>
    ...
    <table id="table_id" class="display" style="width:100%">
        ...
        <tbody thead-light>
            ...
            WHERE P.fk_estado=1 AND P.fk_tipoUsuario=2";
            ...
            ?>
                <tr>
                    ...
                    <td><?php echo $result['telefono1']; ?></td>
                    

                    <td style="width: 170px;"><a class="btn btn-primary btn-sm" href="infoCliente.php?id=<?php echo $result['id_persona']; ?>" title="Ver información">
                        <i class="fa-solid fa-eye"></i></a>
                        <a class="btn btn-danger btn-sm" href="../../funciones/admin/eliminarCliente.php?id=<?php echo $result['id_persona']; ?>" title="Borrar">
            ...
            <div class="modal-body">
                <table id="table_id" class="display" style="width:100%">
                    ...
                    <tbody thead-light>
                        ...
                        $query = "SELECT P.*, D.tipo FROM personas P 
                        INNER JOIN tipousuarios D on P.fk_tipoUsuario=D.id_tipoUsuario 
                        WHERE P.fk_estado=2 AND P.fk_tipoUsuario=2 ";
                        $resultado = $mysqli->query($query);
                        foreach ($resultado as $result) {
                        ?>
                            <tr>
